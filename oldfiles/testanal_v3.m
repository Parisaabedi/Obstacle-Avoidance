...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Written by PAK
% Adapted the analysis to do Functional data Analysis specifically for trajectory data
% test my new analysis
% updated Oct. 2018 to adapt the reaction time calculations (added to the current file
% using several methods based on the paper by Smeets and Brenner, 2018)
...
for subnum = 1 : 18
    ...
    finalname = strcat('Comp3_s', num2str(subnum),'.mat');
